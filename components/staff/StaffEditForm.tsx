...
export function StaffEditForm({ onClose, onSubmit, roles, initialData }: StaffEditFormProps) {
    ...
    const [formData, setFormData] = useState({
        ...
        joinedDate: initialData?.joinedDate || initialData?.joining_date || '',
        permanent_date: initialData?.permanent_date || '',
        ...
        bond_period_from: initialData?.bond_period_from || '',
        bond_period_to: initialData?.bond_period_to || '',
                ...
                try {
                    ...
                    if (details) {
                        setFormData(prev => ({
                            ...
                            date_of_birth: details.date_of_birth || prev.date_of_birth,
                            ...
                            joinedDate: details.joining_date || prev.joinedDate,
                            permanent_date: details.permanent_date || prev.permanent_date,
                            confirmation_date: details.confirmation_date || prev.confirmation_date,
                            ...
                            bond_period_from: details.bond_period_from || prev.bond_period_from,
                            bond_period_to: details.bond_period_to || prev.bond_period_to,
    ...
    const renderField = (label: string, name: string, type: string = 'text', placeholder: string = '', options?: { value: string; label: string }[], isRequired: boolean = false, isReadOnly: boolean = false) => (
                    ...
                    {currentTab === 'basic' && (
                        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-2 duration-400">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-6 border-t border-gray-100 dark:border-gray-800">
                                {renderField('Personal Mobile (Login)', 'contactKey', 'tel', '', [], true)}
                                <div className="col-span-1 md:col-span-2">
                    ...
                    {currentTab === 'employment' && (
                        <div className="space-y-8 animate-in fade-in slide-in-from-right-2 duration-300">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                {renderField('Login Email (System)', 'email', 'email', '', [], true)}
