                        ...
                        <div className="space-y-8 animate-in fade-in duration-300">
                            ...
                            <div className="pt-6 border-t border-gray-100 dark:border-gray-800">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                    ...
                                    {renderField('Personal Mobile (Login)', 'contactKey', 'tel', 'e.g., 0771234567', [], true)}
                                    <div className="col-span-1 md:col-span-2">
                    ...
                    {currentTab === 'employment' && (
                        <div className="space-y-8 animate-in slide-in-from-right-4 duration-300">
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                ...
                                {renderField('Login Email (Office)', 'email', 'email', 'Used for system login', [], true)}
                                ...
                                <div className="pt-6 border-t border-gray-100 dark:border-gray-800 col-span-1 md:col-span-3">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                                        <div className="col-span-1 md:col-span-2">
                                            {renderField('Branch / Location', 'branch', 'select', '', branches.map(b => ({ value: b.id.toString(), label: b.branch_name })), true)}
                                        </div>
                        ...
                        <div className="space-y-8 animate-in slide-in-from-right-4 duration-300">
                            ...
                            <div className="pt-8 border-t border-gray-100 dark:border-gray-800 bg-blue-50/30 dark:bg-blue-950/10 -mx-6 px-6 py-8">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    {renderField('Account Number', 'bank_account_number', 'password', 'Enter account number', [], true)}
