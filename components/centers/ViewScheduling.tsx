...
export function ViewScheduling() {
  ...
  const canApprove = (authService.hasPermission('centers.approve') || authService.hasRole('super_admin') || authService.hasRole('manager')) && !authService.hasRole('admin');
  const canReject = (authService.hasPermission('centers.approve') || authService.hasRole('super_admin') || authService.hasRole('manager')) && !authService.hasRole('admin');
  const canDelete = authService.hasPermission('centers.delete') || authService.hasRole('field_officer');
  const canEdit = authService.hasPermission('centers.edit') || authService.hasRole('super_admin') || authService.hasRole('manager') || authService.hasRole('admin');
