    ...
    const fetchRequests = async () => {
        try {
            ...
            if (activeTab === 'promotion') {
                const data = await promotionService.getRequests(true);
                setPromotionRequests(data);
            } else {
                const data = await salaryIncrementService.getRequests(true);
                setIncrementRequests(data);
            }
        } catch (error) {
        ...
        <div className="p-6">
            ...
            <div className="flex border-b border-gray-200 dark:border-gray-700 mb-6">
                <button
                    ...
                    className={`flex items-center gap-2 px-4 py-3 font-medium text-sm border-b-2 transition-colors ${activeTab === 'promotion'
                ...
                <button
                    ...
                    className={`flex items-center gap-2 px-4 py-3 font-medium text-sm border-b-2 transition-colors ${activeTab === 'salary-increment'
                        ? 'border-blue-600 text-blue-600'
                        : 'border-transparent text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300'
                        }`}
                >
