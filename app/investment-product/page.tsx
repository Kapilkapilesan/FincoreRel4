...
export default function InvestmentProductManagementPage() {
    ...
    const filteredProducts = products.filter(p => {
        ...
        const matchesPayout = payoutFilter === 'all' || p.interest_payout_frequency === payoutFilter;
            ...
            <div className="grid grid-cols-1 gap-6">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                    ...
                    <select
                        ...
                        className="px-6 py-4 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all shadow-sm text-gray-700 dark:text-gray-300 font-bold min-w-[200px] cursor-pointer"
                    >
                                    ...
                                    <tr>
                                        <td colSpan={5} className="px-6 py-20 text-center">
                                            <div className="flex flex-col items-center gap-3">
                                                ...
                                                <p className="text-gray-500 font-bold">Synchronizing products...</p>
                                            </div>
                                        </td>
                                    </tr>
                                        ...
                                        <tr key={p.id} className="hover:bg-indigo-50/30 dark:hover:bg-indigo-900/10 transition-colors group">
                                            <td className="px-6 py-6 cursor-pointer" onClick={() => { setViewingProduct(p); setShowDetailModal(true); }}>
                                                <div className="flex items-center gap-4">
                                                    <div className="p-3 bg-gray-100 dark:bg-gray-700 rounded-2xl group-hover:bg-indigo-100 dark:group-hover:bg-indigo-900/40 transition-colors">
                                                        <Tag className="w-6 h-6 text-indigo-600 dark:text-indigo-400" />
                                                    </div>
                                                    <div>
                                                        <div className="flex items-center gap-2">
                                                            <span className="text-xs font-black px-2 py-0.5 bg-blue-100 text-blue-700 rounded-md font-mono">{p.product_code || 'N/A'}</span>
                                                        ...
                                                        <div className="flex items-center gap-3 mt-1.5">
                                                            ...
                                                            <div className="flex items-center gap-1 text-xs font-bold text-gray-400 uppercase">
                                                                ...
                                                                <span>{p.interest_payout_frequency} Payout</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <td className="px-6 py-6 text-center">
                                                <div className="inline-flex flex-col items-center">
                                                    ...
                                                    <span className="text-[10px] font-black text-gray-400 uppercase tracking-tighter mt-0.5">Annual yield</span>
                                                </div>
                                            </td>
                                            <td className="px-6 py-6 text-center">
                                                <div className="flex flex-col items-center">
                                                    ...
                                                    <span className="text-[10px] font-bold text-red-500 uppercase tracking-tighter mt-0.5">{p.early_withdrawal_penalty}% Penalty</span>
                                                </div>
                                            </td>
                                            <td className="px-6 py-6 text-left">
                                                <div className="space-y-1">
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        <span className="text-xs font-black text-gray-900 dark:text-gray-200">LKR {Number(p.min_amount).toLocaleString()}</span>
                                                    </div>
                                                    <div className="flex items-center gap-2">
                                                        <div className="w-3.5" />
                                                        <span className="text-xs text-gray-500 font-bold">Max:</span>
                                                        <span className="text-xs font-black text-gray-900 dark:text-gray-200">LKR {Number(p.max_amount).toLocaleString()}</span>
                                                    </div>
                                                </div>
                                            </td>
                                    ...
                                    <tr>
                                        <td colSpan={5} className="px-6 py-24 text-center">
                                            <div className="flex flex-col items-center gap-4">
                                                ...
                                                <button
                                                    onClick={() => { setSearchTerm(''); setPayoutFilter('all'); }}
